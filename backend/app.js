...
const salesManagerRefundsRouter = require('./routes/sales-manager-refunds')
const salesManagerStatsRouter = require('./routes/sales-manager-stats')
const salesManagerRevenueRouter = require('./routes/sales-manager-revenue')
...
app.use('/api/sales-manager/refunds', salesManagerRefundsRouter)
app.use('/api/sales-manager/stats', salesManagerStatsRouter)
app.use('/api/sales-manager/revenue', salesManagerRevenueRouter)
